...
// Kept on the original module surface as well as the package barrel. F007 introduced this export;
// WP7a moves its implementation out only so verification and semantic matching stay separate.
export * from "./answer-diff.js";
